...
Canvas rendering component for prototypo.js. Wraps a `<canvas>` element with a Paper.js scene, loads parametric fonts, handles mouse interaction, typographic frame guides, and node editing UI.
...
var pt = instance.view.viewToProject([e.clientX - bcr.left, e.clientY - bcr.top]);
